        ...
        <div className="right">
            <div className="group">
                ...
                <div>
                    ...
                    <p className="desc">Python is commonly used for developing websites and software, task automation, data analysis, and data visualization.</p>
                </div>
            </div>
            <div className="group">
                <div>
                    ...
                    <p className="desc">Salesforce is a cloud-based software company whose main product is a customer relationship management (CRM) system.</p>
                </div>
                <div>
                    <img src={img4} alt='' />
                    <p className="head">  
Java Full Stack</p>
                    <p className="desc">Java full stack refers to web developers that use Java to develop the entire technology.</p>
                </div>
            </div>
        </div>
      </div> 
