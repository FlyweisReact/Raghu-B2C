  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route exect path="/allCourses" element={<AllCourses />} />
        ...
        <Route path="/particularCourse/:id" element={<ParticularCourse />} />
        <Route path="/course/detail/:courseId/:levelId" element={<CourseDetail />} />
        <Route path="/bought/:courseId/:levelId" element={<Bought />} />
        <Route path="/account" element={<Account />} /> 
        <Route path="/purachase-course/:id/:title" element={<AccountDetail />} />
        <Route path="/forgetPassword" element={<For}
