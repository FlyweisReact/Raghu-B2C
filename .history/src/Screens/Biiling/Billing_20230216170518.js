...
const Billing = () => {
 ...
 success ? alert('Payment SuccessFull') : alert("Payment Decline")
    ...
    <>
      ...
      <div className="BillingDiv">
        <div className="left">
          ...
          <button onClick={() => navigate('/thank')}  type='button'>Continue to checkout</button>
          <PayPalScriptProvider options={{ "client-id": "ATdysrjgkk_eI5vhi9XgXaZPDOHY2XbqtfcC3e_9PV2Kz1Vhb-ZG0-t9j_mwNRgE23950RjiOMYg8zPY" }}>
