  ...
  return (
    <>
      ...
      <div className="allNewCourse">
        ...
        {token ?        <button onClick={() => navigate("/freeTrial")}>
          {token ? "" : "START FREE TRIAL"}
        </button>:       <button onClick={() => navigate("/freeTrial")}>
          {token ? "EXPLORE MORE COURSES" : "START FREE TRIAL"}
        </button>}
      ...
      <button className="centerBtn" style={{ width: "400px" }}>
        {token ? "Frequently Viewed" : "VIEW ALL COURSES"}
      </button>
