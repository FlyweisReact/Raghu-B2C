        ...
        <div className="main">
          ...
          {show ? (
            <div className="right">
              <div className="upper">
                <div></div>
                <p className="head" onClick={() => navigate('/course/detail')} >BEGINNER</p>
                <div>
              ...
              <div className="upper">
                <div></div>
                <p className="head" onClick={() => navigate('/course/detail')}>INTERMEDIATE</p>
                <div>
                  <i className="fa-solid fa-heart"> </i>
                  <img src={img} alt="" />
                </div>
              ...
              <div className="upper">
                <div></div>
                <p className="head" onClick={() => navigate('/course/detail')}>EXPERT</p>
                <div>
                  <i className="fa-solid fa-heart"> </i>
                  <img src={img} alt="" />
                </div>
