    ...
    <>
      ...
      <div className="registerForm" id="reg">
        ...
        <form onSubmit={Register}>
          ...
          <br />
          <input type="text" placeholder="Enter Your Email Id" onChange={(e) => setName(e.target.value)} />
          <br />
          <input type="text" placeholder="Enter Your Phone Number" onChange={(e) => setName(e.target.value)} />
          <br />
          <div className="two">
            ...
            <input type="date" placeholder="Select Time Slot" onChange={(e) => setName(e.target.value)} />
          </div>
          <button
            type="button"
