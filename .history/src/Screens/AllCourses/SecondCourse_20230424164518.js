...
const SecondCourse = () => {
  ...
  //   ? data
  //   : data.filter(obj => {
  //     return obj.levels.some(level => level.level === query);
  //   })
  ...
  const filteredArray = data.filter(obj => {
    return obj.levels.some(level => level.level === "Beginner");
  });
    ...
    <>
      ...
      <section id="allCoursses">
        <div className="courseFiveSec">
          ...
          <button  onClick={() => setQuery("Intermediate")}>Intermediate</button>
          <button  onClick={() => setQuery("Expert")}> Expert</button>
        </div>
      </section>
