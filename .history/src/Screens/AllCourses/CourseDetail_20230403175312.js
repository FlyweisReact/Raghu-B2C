...
const CourseDetail = () => {
  ...
  const fetchData = useCallback(async () => {
    try{
      const {data} = await axios.get(`https://52pv9t2fl3.execute-api.ap-south-1.amazonaws.com/dev/api/v1/stduy/levle/642ac3e50c6a43d40c897dee/642ac3e50c6a43d40c897def`)
    }catch(e) { 
      console.log(e)
    }
  },[])
