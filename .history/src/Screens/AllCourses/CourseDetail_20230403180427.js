        ...
        <div className="down">
          ...
          <div className="right">
            ...
            <div className="VD">
              <video controls>
                <source
                  src=  {data?.result?.[0]?.content}
                  type="video/mp4"
                />
              </video>
            </div>
            <div className="three">
              <p className="first">$  {data?.result?.[0]?.content}</p>
              <p className="second">$  {data?.result?.[0]?.content}</p>
              <p className="third">  {data?.result?.[0]?.content}% off</p>
            </div>
