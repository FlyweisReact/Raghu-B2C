...
const CourseDetail = () => {
  ...
  const fetchData = useCallback(async () => {
    try{
      const {data} = await axios.get(`https://52pv9t2fl3.execute-api.ap-south-1.amazonaws.com/dev/api/v1/stduy/levle/63f611c382ead3efae834202/63f611c382ead3efae834203`)
