  ...
  return (
    <>
      ...
      <div className="courseViewd">
        <div className="left">
          <div onClick={() => setCountPercentage('50')}  style={{cursor : 'pointer'}}>
            <p >JAVA</p>
          </div>
          <div  onClick={() => setCountPercentage('70')}   style={{cursor : 'pointer'}} >
            <p >PYTHON</p>
          </div>
          <div onClick={() => setCountPercentage('90')}   style={{cursor : 'pointer'}} >
            <p  >POWER BI</p>
          </div>
        </div>
        <div className="right">
