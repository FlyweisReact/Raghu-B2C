    ...
    <>
      ...
      <div className="courseBanner">
        ...
        {/* <a href="secondCourse#reg"> */}
          <button style={{ cursor: "pointer" }} onClick={() => navigate('/secondCourse#reg')}>Register now</button>
        {/* </a> */}
      </div>
      ...
      <div className="aboutSecond">
        ...
        {data?.data?.map((i ,index) => (
          ...
          <div className="desc">
            ...
            <p> {i.position} </p>
            <div>
            <a href={i.facebook} target='_blank' rel="noreferrer" style={{color : '#aaaaaa'}} >
            <i className="fa-brands fa-facebook-f"></i>
            </a>
            <a href={i.twitter} target='_blank' rel="noreferrer" style={{color : '#aaaaaa'}} >
            <i className="fa-brands fa-twitter"></i>
            </a>
            <a href={i.others} target='_blank' rel="noreferrer" style={{color : '#aaaaaa'}} >
