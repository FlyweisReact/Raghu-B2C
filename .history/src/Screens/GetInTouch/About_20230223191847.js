  ...
  return (
    <>
      ...
      <div className="aboutFirst">
          ...
          <hr />
          <p>Expert-Works is made up of a diverse group of proffesionals with background and skill <br /> sets, but we  all share a common goal: to deliver expectional  results and exceed  our  client's </p>
      </div>
    </>
  );
};
