    ...
    <div className="courseBanner">
      ...
      <div className='abouttwo-sec'>
            <div className='left'>
                ...
                standard training is in the on-demand technologies to Bench Sales companies <br /> and tech entusiasts all over the world. We are known for providing the <br />
                flexibility of self-paced learning and real-time content, allwing everyone to <br />
                </p>
            </div>
