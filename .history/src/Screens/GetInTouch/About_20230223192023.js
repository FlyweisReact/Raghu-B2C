  ...
  return (
    <>
      ...
      <div className="aboutFirst">
          <p>Our Team</p>
          <p>MMEET OUR EXPERTS</p>
          <hr />
          <p>Expert-Works is made up of a diverse group of proffesionals with background and skill <br /> sets, but we  all share a common goal: to deliver expectional  results and exceed  our  client's expecta-</p>
      </div>

      <div className="aboutSecond">
        <div style={{backgroundColor : "#9d4ffd"}}>
        <div></div>
