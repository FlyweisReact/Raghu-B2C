  ...
  return (
    <>
      ...
      <div className="aboutFirst">
          ...
          <hr />
          <p><span style={{color : ''}}>Expert-Works</span> is made up of a diverse group of proffesionals with background and skill <br /> sets, but we  all share a common goal: to deliver expectional  results and exceed  our  client's expecta-</p>
      </div>
