...
const data = [
  ...
  },
  {
    ...
    desc: [
      "key points mentioned in the job postings. They're so desperate to get a job and never go through the job postings thoroughly. So, they end up applying for the job positions in a hurry. Never ever do this, especially when you're mailing your resume to a Fortune 500 company.  ",
      "Read the job postings thoroughly and circle all the key points mentioned. These key points should be there in your resume because that's what your employer actually needs. For example, if a job posting mentions key points such as, must know MS excel and should have excellent communication skills, then you should highlight these points if you master those skills.       ",
    ],
  },
  {
    image: img4,
  ...
  },
  {
    ...
    desc: [
      "Your resume should be updated regularly and keep on adding relevant information and work experience. Remember, your resume should be up-to- date before you submit because you don't want to miss anything that can actually help you get noticed and land your dream job.       ",
    ],
  },
];
    ...
    <>
      ...
      <div className="detailResourceFirst">
        ...
        <h1 style={{ marginTop: "20px" }}>
          5 Tips for an impressive Resume or CV{" "}
        </h1>
        <p style={{ fontSize: "1.4rem", marginTop: "20px" }}>
          A resume is the first thing your employer sees before even hiring you.
          You need to make sure that your resume stands out from the rest. It's
          absolutely crucial to make your resume impressive for that first
          impression. It's always good to refer to a few templates or sample
          resumes online but make sure that you don't copy them exactly. You
          need to design your resume according to the job role/title you're
          applying for. So, never copy any template exactly the way it is. Read
          the following 5 tips for an impressive resume.{" "}
        </p>
      </div>
