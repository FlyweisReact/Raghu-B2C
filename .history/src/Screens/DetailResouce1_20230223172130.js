  ...
  return (
    <>
      ...
      <div className="detailResourceFirst">
        <img src={img} alt="" />
        <p>Your first impression matters and it’s your responsibility to make sure that your first impression is up to the mark, especially in a job interview. Let’s discuss the top 5 tips to help you crack a job interview.</p>
      </div>
