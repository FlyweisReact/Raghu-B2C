  ...
  return (
    <>
      ...
      <div className="newTwoSec">
        ...
        <div className="right">
         <p> See Our most viewed <br /> Course videos</p>
          <button
            style={{
              backgroundColor: "#426fec",
              color: "#fff",
      ...
      <div className="newThreeSec">
        ...
        <div className="right">
            <p className="desc">Many of my coworkers choose to use
Expert-works for continuing education. I feel it has the best selection, training and curriculum vs others I have tried
</p>
<p className="head"></p>
        </div>
        </div>
