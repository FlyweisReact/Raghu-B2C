    ...
    <>
      ...
      <div className="HeaderUp">
        ...
        {/* Facebook Icon */}
          ...
          {/* Linkedin icon */}
          <a
            href="Linkedin URL: https://www.linkedin.com/company/expert-works/"
            target={"_blank"}
            rel="noreferrer"
            style={{ color: "black" }}
          >
          ...
          <a
            ...
            style={{ color: "black" }}
          >
            <i class="fa-brands fa-youtube" style={{ color: "#fe0000" }}></i>
          </a>
        </div>
      </div>
        ...
        <div className="right">
          <ul>
            ...
            <Link to={"/secondCourse"}>
              <li  className={location.pathname === '/secondCourse' ? "activeLink" :"normalList"}>Courses</li>
            </Link>
            <Link to={"/resource"}>
              <li  className={location.pathname === '/resource' ? "activeLink" :"normalList"}>Resources</li>
            </Link>
            {token ? (
              <>
                <li>
              ...
              <>
                ...
                <Link to={"/freeTrial"}>
                  <button className={location.pathname ==='/freeTrial' ? "activeButton" :"" }  >Free Trial </button>
                </Link>
                <li>
                  <i
