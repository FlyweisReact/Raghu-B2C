...
function LoginModal(props) {
  ...
  const loginUser = async (e) => {
    e.preventDefault()
    try{
      const {data } = await axios.post("https://52pv9t2fl3.execute-api.ap-south-1.amazonaws.com/dev/api/v1/sign" , {email , password})
    ...
    >
      ...
      <Modal.Body>
       <Form onSubmit={loginUser}>
          ...
          <button style={{backgroundColor : "#426fec" , color : "#fff" , padding : '5px' , width : '130px', borderRadius : "0px" , border : '1px solid #426fec' , fontSize : "20px"}} type='submit'>
          Login
          </button>
       </Form>
      </Modal.Body>
