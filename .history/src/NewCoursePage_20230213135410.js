  ...
  function MyVerticallyCenteredModal(props) {
    return (
      <Modal
        ...
        centered
        style={{zIndex : '9999' , width : '2000px'}}
      >
        <Modal.Body style={{  border:"5px solid #3fa0fc" ,boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" , padding : '0px'  }}>
      ...
      <div className="NewCourseThree">
        {data?.message?.map((i , index) => (
          ...
          {i.levels?.map((a , index) => (
            <div className="bigOne" key={index} onClick={() => setModalShow(true)}>
              <p>{a.level} </p>
              <div className="last">
