    ...
    <>
          ...
          <ul>
            ...
            {token ? (
              <>
                ...
                <li>
                  <img src={img1} alt="" className="personImg" onClick={() => setuserModal(!userModal)} />
                </li>
              </>
            ) : (
              <>
                <li style={{ fontWeight: "bold" }} className="normalList">Login</li>
                <Link to={"/freeTrial"}>
      ...
      {userModal ? (
        <div className="Userinfo">
          <button type="button" onClick={() => navig}>My Account</button>
