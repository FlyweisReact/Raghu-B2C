...
const data = [
  ...
  },
  {
    ...
    aboutHead: "About This Course",
    about:
      "AWS is a widely used secure, cloud services platform that offers all these computing services
      like storage, computing, content delivery, analytics, computing, database and management. In
      other words, AWS lets you run web and application servers on the internet to host dynamic
      websites, store all your files in one place securely and use managed databases like MySQL,
      Oracle and PostgreSQL to store information. The best part is, you can access your files from
