...
const data = [
  ...
  // salesForce Admin --
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it is important to learn everything from the basics. This course will provide you
      the basic knowledge to get started with Salesforce admin.
      ",
    IncludeHead: "This course includes the following :",
    include: [
      "5 hours of recorded sessions",
