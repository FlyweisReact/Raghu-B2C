...
const data = [
  ...
  },
  {
    ...
    aboutHead: "About This Course",
    about:
      "Big Data is a popular term in the IT industry and is used by giants like Google, Facebook, and
     Yahoo. This course is designed by an experienced Big Data engineer to make you practically      strong, not just theoretically. You will get real-time experience with this course and gain practical      knowledge. All the best!!",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the basic knowledge to get started with Python.",
    include: [
      "5 hours of recorded sessions",
