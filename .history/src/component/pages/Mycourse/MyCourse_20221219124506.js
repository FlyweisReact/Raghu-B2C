...
const data = [
  ...
  },
  {
    ...
    aboutHead: "About This Course",
    about:
      "UiPath software offers solutions for enterprises to automate repetitive office tasks for rapid
      business transformation. In today’s digital world, it’s impossible to carry out tasks without
      automation. This course is designed by a UI Path expert and brought to you by Expert-Works
