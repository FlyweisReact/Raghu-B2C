...
const data = [
  {
    image:
      ...
      ,
      include : ['5 hours of recorded sessions' , "3 assignments" , "1 mini-project" , "Real-time contents " , "Questions & Answers"]
  },
  {
    image:
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="neww">
                        ...
                        <p style={{padding : '10px' , textAlign : 'center'}}><strong>Beginner :</strong> <br /> {i.detail}  </p>
                        <p style={{padding : '10px' , textAlign : 'center'}}><strong>This course includes the following:</strong> <br /> {i.include?.map((j ,index) => (
                          <ul>
                            <listyle={{ textAlign : 'left' , marginLeft : '30px'}}>{j}</li>
                          </ul>
                        ))}  </p>
                    </div>
                  </div>
