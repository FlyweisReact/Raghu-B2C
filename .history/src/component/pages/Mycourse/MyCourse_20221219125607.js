...
const data = [
  ...
  },
  {
    ...
    aboutHead: "About This Course",
    about:
      "Microsoft Azure is one of the best cloud computing services. This course is designed by an
    expert to provide you with the best real-time content. This course will help you understand      everything needed to become an expert in Azure. All the best!      ",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the basic knowledge to get started with Python.",
    include: [
      "5 hours of recorded sessions",
