...
const data = [
  ...
  // SalesForce Developer
  {
    ...
    aboutHead: "About This Course",
    about:
      "A Salesforce Developer plays an important role in Customer Relationship Management! This
      course is designed by an expert to provide you with the best real-time content. This course will
      help you understand everything needed to excel as a Salesforce Developer. All the best!",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the basic knowledge to get started with Python.",
    include: [
      "5 hours of recorded sessions",
