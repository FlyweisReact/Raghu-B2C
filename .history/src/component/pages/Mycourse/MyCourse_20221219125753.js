...
const data = [
  ...
  // Power BI
  {
    ...
    aboutHead: "About This Course",
    about:
      "This is a complete course on Power Bi divided into different parts.You will be first introduced to
      the SQL and Data Warehousing concepts, which are divided into two parts. After this, you will
      learn about PowerBI Desktop (used to create visualizations) under which you will explore
      connecting and shaping data, creating a data model, adding calculated fields with DAX and
      finally visualizing data with reports and dashboards.Next, you will learn Artificial Intelligence
      visuals, creating Python Visuals in PowerBI, and performance tuning and best practices. The
      course will end with PowerBI Service, under which you will be learning how to share and
      collaborate the reports in your organization.The Demo files and Presentations needed to follow
      the course are available for download.
      ",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the basic knowledge to get started with Python.",
    include: [
