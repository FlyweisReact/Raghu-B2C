...
const data = [
  ...
  },
  {
    ...
    about:
     ...
     patterns useful for decision making. This course is designed by an experienced Deep Learning      expert to provide you the best real-time content. This course will helpyou understand everything      needed to excel in this industry. All the best!",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the basic knowledge to get started with Python.",
    include: [
      "5 hours of recorded sessions",
