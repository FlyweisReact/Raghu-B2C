...
const data = [
  ...
  // Machine Learning --
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you
      with the basic knowledge to get started with Machine Learning.
      ",
    IncludeHead: "This course includes the following :",
    include: [
      "5 hours of recorded sessions",
