...
const data = [
  ...
  },
  {
    ...
    detailHead: "Expert",
    detail:
      "This course is for people who have Intermediate level knowledge in Python and want to become   an expert. You will get the right practical knowledge to become a Python expert with this course.",
    IncludeHead: "This course includes the following :",
    include: [
      "6.5 hours of recorded sessions",
      "3 assignments",
      "1 mini-project",
      "Real-time contents ",
      "Questions & Answers",
  ...
  // Automation Anywhere---
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the basic knowledge to get started with Automation Anywhere.",
    IncludeHead: "This course includes the following :",
    include: [
      "5 hours of recorded sessions",
      "3 assignments",
...

  {
    ...
    detailHead: "Beginner",
    detail:
      "This course is for people who have basic knowledge about Automation Anywhere and want to      learn more practically. This course will help you become familiar with industry standard concepts      in Automation Anywhere.      ",
    IncludeHead: "This course includes the following :",
    include: [
      "14 hours of recorded sessions",
      "9 assignments",
...

  {
    ...
    detailHead: "Expert",
    detail:
      "This course is for people who have Intermediate level knowledge in Automation Anywhere and      want to become an expert. You will get the right practical knowledge to become an Automation     Anywhere expert with this course.      ",
    IncludeHead: "This course includes the following :",
    include: [
  ...
  // Deep Learning ---
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the      basic knowledge to get started with Deep Learning.      ",
    IncludeHead: "This course includes the following :",
    include: [
      "6 hours of recorded sessions",
      "5 assignments",
...

  {
    ...
    detailHead: "Intermediate",
    detail:
      "This course is for people who have basic knowledge about Deep Learning and want to learn     more practically. This course will help you become familiar with industry standard concepts in     Deep Learning.      ",
    IncludeHead: "This course includes the following :",
    include: [
...

  {
    ...
    detailHead: "Expert",
    detail:
      "This course is for people who have Intermediate level knowledge in Deep Learning and want to     become an expert. You will get the right practical knowledge to become a Deep Learning expert      with this course.",
    IncludeHead: "This course includes the following :",
    include: [
  ...
  // UI--
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the  basic knowledge to get started with Ui Path.",
    IncludeHead: "This course includes the following :",
    include: [
      "6 hours of recorded sessions",
      "3 assignments",
...

  {
    ...
    detailHead: "Expert",
    detail:
      "This course is for people who have Intermediate level knowledge in Ui Path and want to      become an expert. You will get the right practical knowledge to become a Ui Path expert with      this course.      ",
    IncludeHead: "This course includes the following :",
    include: [
      "9 hours of recorded sessions",
      "6 assignments",
  ...
  // JAVA --
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the      basic knowledge to get started with Java FullStack",
    IncludeHead: "This course includes the following :",
    include: [
...

  {
    ...
    detailHead: "Intermediate",
    detail:
      "This course is for people who have basic knowledge about Java FullStack and want to learn      more practically. This course will help you become familiar with industry standard concepts in      Java FullStack",
    IncludeHead: "This course includes the following :",
    include: [
      "3 hours of recorded sessions",
      "2 assignments",
  ...
  },
  {
    ...
    detailHead: "Expert",
    detail:
      "This course is for people who have Intermediate level knowledge in Java FullStack and want to      become an expert. You will get the right practical knowledge to become a Full Stack expert with      this course",
    IncludeHead: "This course includes the following :",
    include: [
      "5 hours of recorded sessions",
      "3 assignments",
  ...
  // Machine Learning --
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you with the basic knowledge to get started with Machine Learning. ",
    IncludeHead: "This course includes the following :",
    include: [
  ...
  
  {
    ...
    detailHead: "Intermediate",
    detail:
      "This course is for people who have basic knowledge about Machine Learning and want to learn      more practically. This course will help you become familiar with industry standard concepts in      Machine Learning.",
    IncludeHead: "This course includes the following :",
    include: [
      "10 hours of recorded sessions",
      "9  assignments",
      "2 mini-project",
      "Real-time contents ",
      "Questions & Answers",
  ...
  // JAVA ---
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the     basic knowledge to get started with JAVA.      ",
    IncludeHead: "This course includes the following :",
    include: [
      "9 hours of recorded sessions",
      "3 assignments",
  ...
  },
  {
    ...
    detailHead: "Intermediate",
    detail:
      "This course is for people who have basic knowledge about JAVA and want to learn more     practically. This course will help you become familiar with industry standard concepts in JAVA",
    IncludeHead: "This course includes the following :",
    include: [
      "12 hours of recorded sessions",
      "2 assignments",
...

  {
    ...
    detailHead: "Expert",
    detail:
      "This course is for people who have Intermediate level knowledge in JAVA and want to become     an expert. You will get the right practical knowledge to become a JAVA expert with this course",
    IncludeHead: "This course includes the following :",
    include: [
      "5 hours of recorded sessions",
      "2 assignments",
  ...
  // SalesForce Developer
  {
    ...
    detailHead: "Beginner",
    detail:
      "This course is for people who have basic knowledge about Salesforce Developer and want to      learn more practically. This course will help you become familiar with industry standard concepts      in Salesforce Developer.",
    IncludeHead: "This course includes the following :",
    include: [
      "5 hours of recorded sessions",
      "8 assignments",
...

  {
    ...
    detailHead: "Intermediate",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the     basic knowledge to get started with Salesforce Developer.     ",
    IncludeHead: "This course includes the following :",
    include: [
      "15 hours of recorded sessions",
      "20 assignments",
  ...
  },
  {
    ...
    detailHead: "Expert",
    detail:
      "This course is for people who have Intermediate level knowledge in Salesforce Developer and      want to become an expert. You will get the right practical knowledge to become a Salesforce      Developer expert with this course",
    IncludeHead: "This course includes the following :",
    include: [
      "8 hours of recorded sessions",
      "15 assignments",
  ...
  // salesForce Admin --
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it is important to learn everything from the basics. This course will provide you      the basic knowledge to get started with Salesforce admin.      ",
    IncludeHead: "This course includes the following :",
    include: [
      "3.5 hours of recorded sessions",
      "Real-time contents ",
      "Questions & Answers",
    ],
  },
...

  {
    ...
    detailHead: "Intermediate",
    detail:
      "This course is for people who have basic knowledge about Salesforce admin and want to learn      more practically. This course will help you become familiar with industry standard concepts in      Salesforce admin.",
    IncludeHead: "This course includes the following :",
    include: [
      "3.5 hours of recorded sessions",
      "Real-time contents ",
  ...
  },
  {
    ...
    detailHead: "Expert",
    detail:
      "This course is for people who have Intermediate level knowledge in Salesforce admin and want      to become an expert. You will get the right practical knowledge to become a Salesforce admin      expert with this course.",
    IncludeHead: "This course includes the following :",
    include: [
      "3.5 hours of recorded sessions",
      "Real-time contents ",
  ...
  // Microsofe Azure --
  {
    ...
    detailHead: "Beginner",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the           basic knowledge to get started with Microsoft Azure.",
    IncludeHead: "This course includes the following :",
    include: [
      "10 hours of recorded sessions",
      "4 assignments",
...

  {
    ...
    detailHead: "Intermediate",
    detail:
      "This course is for people who have basic knowledge about Microsoft Azure and want to learn     more practically. This course will help you become familiar with industry standard concepts in      Microsoft Azure.      ",
    IncludeHead: "This course includes the following :",
    include: [
      "20 hours of recorded sessions",
      "5 assignments",
      "Real-time contents ",
      "Questions & Answers",
    ],
  ...
  
  {
    ...
    detailHead: "Expert",
    detail:
      "This course is for people who have Intermediate level knowledge in Microsoft Azure and want to      become an expert. You will get the right practical knowledge to become a Microsoft Azure      expert with this course",
    IncludeHead: "This course includes the following :",
    include: [
      "20 hours of recorded sessions",
      "5 assignments",
          ...
          return (
            <>
              <div
                ...
                onClick={() => navigate(`/myCourse/${i._id}`)}
                key={index}
              >
                <div className="card">
