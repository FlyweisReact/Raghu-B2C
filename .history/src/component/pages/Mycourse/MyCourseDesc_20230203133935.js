...
const MyCourseDesc = () => {
  ...
  const fetchHandler = useCallback(async () => {
    try{
      ...
      setData(data)
  setVideo(data?.message?.[0]?.mainInfo?.video)
    }catch(err){
      console.log(err)
    }
  },[id])
...
function ModalVideo (data) {
  setVideo('https://d3s24np0er9fug.cloudfront.net/phase1/public/LMS%20New.mp4')
}
                ...
                <Typography className="bold-p">
                  <div className="Dess">
                    ...
                    <img
                      ...
                      onClick={() => setVideo('https://d3s24np0er9fug.cloudfront.net/phase1/public/LMS%20New.mp4')}
                    />
