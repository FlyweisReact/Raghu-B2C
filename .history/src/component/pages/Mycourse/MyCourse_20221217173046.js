    ...
    <>
      ...
      >
        ...
        <div>
          ...
          <p style={{fontSize : '1.3rem' , marginLeft  : '20px' , marginTop : '10px'}}>
            {" "}
            <strong>Beginner : </strong> s a beginner, it’s important to learn everything from the basics. This course will provide you the
