...
const data = [
  ...
  // Machine Learning --
  {
    ...
    aboutHead: "About This Course",
    about:
      "Machine Learning is the most happening technology right now and with unlimited job
      opportunities. It is a branch of artificial intelligence based on the idea that machines can actually
      learn from data and hence, decisions can be made with minimal human intervention. This
      course is designed by the best industry expert to provide you the best content. We encourage
      you to practice more. All the best!",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the basic knowledge to get started with Python.",
    include: [
      "5 hours of recorded sessions",
