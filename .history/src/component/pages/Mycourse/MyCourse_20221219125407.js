...
const data = [
  ...
  // salesForce Admin --
  {
    ...
    aboutHead: "About This Course",
    about:
    "Salesforce administrators help companies run their businesses successfully by managing the
    Salesforce cloud ecosystem and solving their business problems. This course is designed by an
      expert to provide you with the best real-time content. This course will help you understand
      everything needed to become a Salesforce admin. All the best!",
    detail:
      "As a beginner, it’s important to learn everything from the basics. This course will provide you the basic knowledge to get started with Python.",
    include: [
      "5 hours of recorded sessions",
