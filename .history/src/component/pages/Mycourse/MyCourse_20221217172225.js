...
const data = [
  {
    ...
    Beginner : "As a beginner, it’s important to learn everything from the basics. This course will provide you the  basic knowledge to get started with Python."
  },
  {
    image:
                ...
                <div className="card">
                  <div className="card-body">
                    <img
                      ...
                      alt=""
                    />
                    <div className="card-about"> <strong>About this Course :</strong> {i.about}</div>
                    <div className="card-about"> <strong>Beginner :</strong> {i.Beginner}</div>
                    <div className="card-about"> <strong>This course includes the following :</strong> {i.5 hours of recorded sessions
3 assignments
1 mini-project
Real-time contents
Questions & Answers
